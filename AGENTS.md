...
All Java code in this repository, including production code and tests, must follow
the project-specific `seedu-java-coding-standard` skill. Load and apply that skill
before creating or modifying Java code.
