...
4. Run the bundled generator from the repository root with a Python 3 interpreter:
   ...
   On Windows, use `python` when it is available. In Codex Desktop, if Python is
   not on `PATH`, load the workspace dependencies and use the bundled Python
